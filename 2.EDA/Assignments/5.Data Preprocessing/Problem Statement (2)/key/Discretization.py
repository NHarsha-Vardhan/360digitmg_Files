...
iris = pd.read_csv(r"F:\Liser Time\360digitmg\2.EDA\Data Sets\InClass_DataPreprocessing_datasets\iris.csv")
iris.dtypes
...
a=pd.cut(iris['Sepal.Length'], bins=3, labels=np.arange(3), right=False)

#How the binning is done:
b=pd.cut(iris['Sepal.Length'], bins=3, right=False)
