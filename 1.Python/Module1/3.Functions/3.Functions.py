...
def hello(name,age, sal):                 
    print("hi", age, "your age:",name , "your salary:", sal)

hello(50000,"Sharat", 25 )
...
intro(Firstname = "John", Lastname = "Wood", Email = ["johnwood@nomail.com","john@hotmail.com"], Country = "Wakanda", Age = 25, Phone = [9876543210,9876543210])
...
a_1 = list(map(lambda x: x * 2, val))
print(a_1)


a_1 = [map(lambda x: x * 2, val)]
print(a_1)
...
## filter() returns a subset of the original array based on custom criteria. In your callback function,
## return a boolean value to determine whether or not each item will be included in the new array
...
## reduce() can be used to return almost anything. It is often used to return a single number, like an sum, 
##but it can also be used to combine the logic of Map and Filter to return an array of values matching certain
