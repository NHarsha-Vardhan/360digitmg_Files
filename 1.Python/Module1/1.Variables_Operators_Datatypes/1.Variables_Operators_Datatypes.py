...
#when we apply 'and' operator to non conditional statements i.e on strings and numbers it will as per 
#the non -zero exists on left side of and condiy=tion it gives right side value.
a = 3 ; b=2 ; c = 0

a and b , b and c , b and a
print('orange'and 'apple')
print(''and 'apple') # the  left side of and is null value i.e(similar to zero value) so it print left side value.
...
Num = "this is stringexample hi 123"
Num.isalnum()
...
# Functions of Date in datetime is:
#fromisoformat() ,replace(),isocalendar() ,datetime.now()
