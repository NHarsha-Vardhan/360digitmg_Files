...
x = random.randint(3, 9) # Gives the random variable in integer form number

print(x)
y_1 = random.ranf((4,10)) # creates the random variable in Float form number in uniform distribution in 1-D and 2-D form
print(y_1)
random_floats = np.random.rand(4,10) # creates the random variable in integer form number in uniform distribution 1-D and 2-D form
...
d.plot.area(alpha= 0.5, color = ['coral','purple','lightgreen'],figsize = (8,6),fontsize = 12)
...
education = pd.read_csv(r"F:\Liser Time\360digitmg\1.Python\Module1\Assignments\problem statement-08\datasets\education.csv")
...
plt.boxplot(education.gmat,vert=False) # boxplot
help(plt.boxplot)
